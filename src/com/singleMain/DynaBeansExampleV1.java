...
public class DynaBeansExampleV1 {
	public static void main(String args[]) throws Exception {
		...
		/*Gson gson = new Gson();// gson-2.2.4.jar
		...
		System.err.println(BeanUtils.getProperty(movie, "dateOfRelease"));
		System.err.println(BeanUtils.getProperty(movie, "genre"));
		System.err.println(BeanUtils.getProperty(movie, "director.gender"));
	}
